...
#else
#define CIU_CLK       200000	/* In KHz. 24 MHz */
#endif
#define SD_MAX_OPFREQUENCY  25000       
#define MMC_MAX_OPFREQUENCY 20000
...
#define FDD_VALUE      50000  /* 4000 KHz */
...
#define SD_FOD_DIVIDER_VALUE	((CIU_CLK/(FOD_VALUE*2))+1)
#define SD_FPP_FREQ_DIV       ((CIU_CLK/(FDD_VALUE*2))+1)
//#define SD_FPP_FREQ_DIV       2

#define SD_ONE_BIT_BUS_FREQ_DIV  ((CIU_CLK/(FOD_VALUE*2))+1)
