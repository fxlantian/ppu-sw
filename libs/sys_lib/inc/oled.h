...
//#define OLED_RST_Clr() set_gpio_pin_value(31, 0)//RES
//#define OLED_RST_Set() set_gpio_pin_value(31, 1)

#define OLED_DC_Clr() set_gpio_pin_value(PIN3, 0)//DC
#define OLED_DC_Set() set_gpio_pin_value(PIN3, 1)
