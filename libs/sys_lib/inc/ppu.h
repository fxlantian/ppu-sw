...
#define PPU_BASE_ADDR             0x60000000

/**  ANN **/
#define ANN_BASE_ADDR          	  0x7FFFE000

/**  emmc controller  **/
#define EMMC_BASE_ADDR            0x7FFFF000

/**  lpddr memory controller **/
#define MEMCTL_BASE_ADDR          0x7FFFC000
...
/**  camera controller  **/
#define CAMCTL_BASE_ADDR          0x7FFFD000
...
/** SOC PERIPHERALS */
#define SOC_PERIPHERALS_BASE_ADDR     ( PPU_BASE_ADDR + 0x0000000 )
...
#define PWM_BASE_ADDR                 ( SOC_PERIPHERALS_BASE_ADDR + 0xA000 )
...
/** Instruction RAM */
#define INSTR_RAM_BASE_ADDR           ( 0x88000000 )
#define INSTR_RAM_START_ADDR          ( 0x88000080 )
...
/** Data RAM */
#define DATA_RAM_BASE_ADDR            ( 0x88010000 )
